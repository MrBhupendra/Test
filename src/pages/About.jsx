  ...
  return (
    <div className='border border-black flex px-28  py-16'>
        <div className='border border-black w-full'>
            <img className='object-cover' src='https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'></img>
           
        </div>
        <div className='border border-black w-full px-10 flex flex-col gap-3 justify-center '>
            ...
            <h1 className='about-headline font-serif text-3xl'>Full-Stack Developer Crafting Scalable & Engaging Experiences</h1>
