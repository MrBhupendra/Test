  ...
  return (
    <div className='sticky top-0 '>
      <header className='Navbar  '>
        <nav className='flex justify-between px-24 items-center p-2 bg-white  max-sm:w-auto max-sm:flex max-sm:justify-between max-sm:border border-black max-sm:px-3'>
