...
function About() {
  return (
    <div className='border border-black flex px-24  py-16'>
        ...
        <div className=' w-full px-12 py-20 flex flex-col gap-3 justify-center bg-blue-300 '>
            ...
            <div className='py-2'>
              <button className='  bg-black  font-semibold flex justify-center gap-1 rounded-full'><span className=' flex justify-center items-center text-2xl text-white  ml-2  '><Icon icon="mdi-light:arrow-right"/></span><span className='bg-purple-600  py-2.5 rounded-full px-5'>Go Project</span></button> 
            </div>
