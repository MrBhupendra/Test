...
function Skill() {
  return (
    <div className='px-24 py-6 bg-sky-100 '>
      <div className='skill border border-black py-5 px-8 flex flex-col justify-center items-center'>
        <h1 className='font-bold text-3xl'>Our Technology</h1>
        <p className='font-medium text-slate-500 w-[50%] text-[14px] mt-1 text-center'>I specialize in front-end and back-end technologies, including React, Node.js, Express, and databases, to build efficient, scalable web applications.</p>
